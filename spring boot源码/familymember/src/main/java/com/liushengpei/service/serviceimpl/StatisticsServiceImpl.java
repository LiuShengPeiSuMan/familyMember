...
public class StatisticsServiceImpl implements IStatisticsService {
    ...
    public Map<String, Object> statisticsData() {
        ...
        //男女比例
        List<Map<String, Object>> maps = familyMemberDao.manAndWomanNum();
        map.put("proportion", maps);
        //年龄段数量统计
        List<Integer> queryAllAge = familyMemberDao.queryAllAge();
        //存储年龄段数据
        ...
        //出生成员年度统计
        List<Date> dates = babySituationDao.yearData();
